...
export CXXSTDLIB_X86_64_UNKNOWN_LINUX_OHOS=c++
...
export CARGO_TARGET_X86_64_UNKNOWN_LINUX_OHOS_LINKER=$TARGET_CC
export CARGO_ENCODED_RUSTFLAGS="-Clink-args=--target=x86_64-linux-ohos --sysroot=$OHOS_SDK_HOME/native/sysroot -D__MUSL__"
